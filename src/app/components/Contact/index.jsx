    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4 py-10">
      <div className="bg-white rounded-3xl shadow-lg overflow-hidden flex flex-col md:flex-row w-full max-w-4xl">
        ...
        <div className="hidden md:block md:w-1/2 relative min-h-[250px] sm:min-h-[400px] lg:min-h-[500px]">
          <Image
            src="https://plus.unsplash.com/premium_photo-1678304224523-d25b4117558f?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="Contact Us"
            fill
